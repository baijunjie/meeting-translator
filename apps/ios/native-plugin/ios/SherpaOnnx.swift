...
///
/// VENDORED VERBATIM from k2-fsa/sherpa-onnx @ v1.13.3:
///   https://github.com/k2-fsa/sherpa-onnx/blob/v1.13.3/swift-api-examples/SherpaOnnx.swift
/// Apache-2.0. Do NOT edit by hand — re-copy from the matching release tag when the
/// sherpa-onnx.xcframework is upgraded (the Swift wrapper must match the C API in
/// sherpa-onnx/c-api/c-api.h shipped by that xcframework). See ../INTEGRATION.md.
