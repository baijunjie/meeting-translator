...
<template>
  <div class="relative flex flex-1 flex-col overflow-hidden">
    ...
    <div class="shrink-0">
      ...
      <transition name="rise">
        <div
          ...
          class="mx-auto mt-5 flex max-w-[88%] items-center justify-center rounded-2xl border border-dashed border-amber-500/45 bg-amber-500/[0.07] px-6 py-6 text-center"
        >
          <div
            v-if="partial"
      ...
      <transition name="rise">
        <div
          ...
          class="mx-auto mt-5 flex max-w-[88%] flex-col items-center justify-center rounded-2xl border border-blue-500/30 bg-blue-500/10 px-6 py-7 text-center"
        >
    ...
    <div
      ref="scroller"
      class="flex-1 overflow-y-auto px-5 pb-5 pt-7 [overflow-anchor:none]"
      @scroll="onScroll"
    >
